...
namespace Coupon.Application.Tests
{
    ...
    public class CustomAutoDataAttribute : AutoDataAttribute
    {
        ...
        private static IFixture CreateFixture
        {
            get
            {
                ...
                fixture.Behaviors.Add(new GenerationDepthBehavior(5));
    ...
    public class GenerationDepthGuard : ISpecimenBuilderNode
    {
        private readonly ThreadLocal<Stack<DepthSeededRequest>> requestsByThread
            = new(() => new Stack<DepthSeededRequest>());
        ...
        public GenerationDepthGuard(ISpecimenBuilder builder, IEqualityComparer comparer)
        {
            ...
            this.GenerationDepthHandler = default!;
        }
        ...
        public object Create(object request, ISpecimenContext context)
        {
            if (request is SeededRequest)
            {
                ...
                DepthSeededRequest depthRequest = new(((SeededRequest)request).Request, ((SeededRequest)request).Seed, currentDepth);
